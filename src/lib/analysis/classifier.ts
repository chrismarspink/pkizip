...
const ENTITY_WEIGHTS: Record<string, number> = {
  ...
  // JP PII — マイナンバー法(§19) 별도 적용되는 JP_MY_NUMBER 는 KR_RRN 보다 높게 가중
  JP_MY_NUMBER: 6.0, JP_PASSPORT: 4.5, JP_DRIVERS_LICENSE: 4.0,
  JP_BANK_ACCOUNT: 3.0, JP_CORPORATE_NUMBER: 1.5,
  JP_ADDRESS: 1.5, JP_PHONE: 0.5, JP_POSTAL_CODE: 0.4,
};
...
export const GRADE_KEYWORDS: Array<[string, number, string]> = [
  ...
  ['신용정보법', 1.5, '신용정보법'],
  ['보안3등급', 1.0, '보안3등급'],
  // 일본 정부 표준 (情報セキュリティ管理基準 / 防衛省訓令 등)
  ['極秘', 4.0, '極秘 (極秘)'],
  ['秘', 3.5, '秘'],
  ['取扱注意', 2.0, '取扱注意'],
  ['関係者外秘', 2.5, '関係者外秘'],
  ['関係者限り', 1.5, '関係者限り'],
  // 일본 기업 표준 (情報セキュリティ管理基準·経済産業省 가이드)
  ['機密', 3.0, '機密'],
  ['社外秘', 3.0, '社外秘'],
  ['部外秘', 2.5, '部外秘'],
  ['マル秘', 3.0, 'マル秘 (㊙)'],
